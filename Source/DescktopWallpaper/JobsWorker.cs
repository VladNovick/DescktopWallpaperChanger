...
namespace SGCombo.Wallpaper.Changer
{
    public class JobsWorker
    {
        ...
        {
            WallpaperBgWorker my_WallpaperBgWorker = (WallpaperBgWorker)sender;
            WallpaperBgWorker try_WallpaperBgWorker;
            dictionaryBag.TryRemove(my_WallpaperBgWorker.Key, out try_WallpaperBgWorker);
           // IdentifyQueryBackground identifiedQuery = null;
